...
-   **options**: an object specifying a set of name-value pairs. The currently acceptable options are:
    ...
    -   _forceScanFilter_: _true_ or _false_ to [to force an empty scan filter](https://github.com/don/cordova-plugin-ble-central/issues/987) bluetooth spec.pre-4.2 advertisements on Android.
