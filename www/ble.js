cordova.define("cordova-plugin-ble-central.ble", function (require, exports, module) {
    ...
    module.exports = {
        ...
        requestConnectionPriority: function (id, priority, success, failure) {
            cordova.exec(success, failure, 'BLE', 'requestConnectionPriority', [id, priority]);
        },
        checkBleSupported: function (success, failure) {
            cordova.exec(success, failure, 'BLE', 'checkBleSupported', []);
        },
        checkClassicSupported: function (success, failure) {
            cordova.exec(success, failure, 'BLE', 'checkClassicSupported', []);
        },
